 ...
 */
public class MyIcsLinearLayout extends LinearLayout {
    ...
    public MyIcsLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(MyIcsLinearLayout.LL_DIVIDER));
